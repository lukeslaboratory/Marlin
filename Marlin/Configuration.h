...
//Configured by Luke's Laboratory 7-22-19
...
#define STRING_CONFIG_H_AUTHOR "(Luke'sLab, Rigidbot XL Corexy)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "http://www.lukeslab.online"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "MONGO"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 9.
  #define DEFAULT_Ki .36
  #define DEFAULT_Kd 54
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 1600, 281.4 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 700, 700, 10, 100 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.3   // Z offset: -below +above  [the nozzle]
...
#define PREHEAT_2_TEMP_HOTEND 280
...
// https://bitbucket.org/fmalpartida/new-liquidcrystal/wiki/ 
//
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    P1_17        // LED driving pin
  #define NEOPIXEL_PIXELS 79       // Number of LEDs in the strip
